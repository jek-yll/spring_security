...
public class ProductRestController {
    ...
    @PostMapping("/product") // http://localhost:8080/api-v1/product
    ...
    @PutMapping("product/{id}") // http://localhost:8080/api-v1/product/*
    public void update(@PathVariable("id") Long id, @RequestBody Product productUpdate){
